<div class="login-page">
    <div class="login-box">
        ...
        <div class="login-methods">
            ...
            <?php if (LOGIN_TELEGRAM_ENABLED && TELEGRAM_BOT_USERNAME): ?>
            ...
            <?php elseif (!LOGIN_TELEGRAM_ENABLED && TELEGRAM_BOT_USERNAME): ?>
            <div class="telegram-placeholder">
                <span>Telegram (deshabilitado en configuración)</span>
            </div>
            <?php elseif (!TELEGRAM_BOT_USERNAME): ?>
            <div class="telegram-placeholder">
